...
\frac{1}{w^\alpha+x}=\varphi(w;x)\biggl(
    \frac{1}{w-\gamma_+}+\frac{1}{w-\gamma-}\biggr)
\]
with
\[
...
w-\gamma_\mp=\gamma_\pm-\gamma_\mp+\gamma_\pm\epsilon_\pm,\qquad
2w-\gamma_+-\gamma_-=\gamma_+-\gamma_-+2\gamma_\pm\epsilon_\pm,
\]
We have
\[
...
(\gamma_\pm-\gamma_\mp+\gamma_\pm\epsilon_\pm)(\gamma_\pm\epsilon_\pm)
+\alpha^{-1}\gamma_\pm^{1-\beta}
x\epsilon_\pm[\alpha+\epsilon_\pm\psi_{2,\alpha}(\epsilon_\pm)]
(\gamma_\pm-\gamma_\mp+2\gamma_\pm\epsilon_\pm)\\
&=x\gamma_\pm^{1-\beta}\epsilon_\pm\Bigl(-(1+\epsilon_\pm)^{\alpha-\beta}
(\gamma_\pm-\gamma_\mp+\gamma_\pm\epsilon_\pm)
+[1+\alpha^{-1}\epsilon_\pm\psi_{2,\alpha}(\epsilon_\pm)]
(\gamma_\pm-\gamma_\mp+2\gamma_\pm\epsilon_\pm)\Bigr)\\
&=x\gamma_\pm^{1-\beta}\epsilon_\pm^2\Bigl(
(\gamma_\pm-\gamma_\mp+\gamma_\pm\epsilon_\pm)
...
so
\[
H_\pm(w;x)=\frac{(\gamma_\pm-\gamma_\mp+\gamma_\pm\epsilon_\pm)
[\psi_{1,\alpha-\beta}(\epsilon_\pm)-\alpha^{-1}\psi_{2,\alpha}(\epsilon_\pm)]
-\alpha^{-1}\psi_{1,\alpha}(\epsilon_\pm)\gamma_\pm}%
{\gamma_\pm^\beta\psi_{1,\alpha}(\epsilon_\pm)
(\gamma_\pm-\gamma_\mp+2\gamma_\pm\epsilon_\mp)}.
\]
In particular,
\[
H_\pm(\gamma_pm;x)=\frac{(1+\alpha-2\beta)(\gamma_\pm-\gamma_\mp)-2\gamma_\pm}%
{2\alpha\gamma_\pm^\beta(\gamma_\pm-\gamma_\mp)}.
\]
Similarly,
\[
...
-\alpha^{-1}\gamma_\mp^{1-\beta}\psi_{1,\alpha}(\epsilon_\pm)
(\gamma_\pm-\gamma_\mp+2\gamma_\pm\epsilon_\pm)}%
{\psi_{1,\alpha}(\epsilon_\pm)(\gamma_\pm-\gamma_\mp+2\gamma_\pm\epsilon_\pm)
(\gamma_\pm-\gamma_\mp+\gamma_\pm\epsilon_\pm)}.
\]
In particular,
\[
